  ...
  var app = {
    ...
    render: function() {
      const htmls = this.songs.map ((song , index) => {
           ...
           <div class="song__right">
               <i class="fa-solid fa-heart song__favorite"></i>
               <span class="song__fulltimes">3:68</span>
           </div>
       </div>`
      })
      spacesChill.innerHTML = htmls.join('');
    },
    defineProperties: function() {
       ...
       handleEvents: function() {
        ...
        spacesChill.onclick = function(e) {
       ...
       loadCurrentSong: function() {
          const heading = $('.cdthumb__name');
          const artist = $('.cdthumb__artist');
          const audio = $('#audio');
          const playingName = $('.header__mbl-name')
          const playingArtist = $('.header__mbl-artist')
...
//         return `<li class="listplay__item"><a href="" class="listplay__link">
//         <div class="media listplay__link-warper">
//             <div class="media__primary">
//                 <div class="media__left">
//                     <img src="${song.thumb}" alt="" class="media__left-img listplay__thumb">
//                 </div>
//                 <div class="media__content">
//                     <h3 class="media__content-name">${song.name}</h3>
//                     <p class="media__content-artist">${song.artist}</p>
//                 </div>
//             </div>
